          ...
          <div className="relative">
            <div className="mb-stack-sm sm:mb-stack-lg text-center">
              ...
              <p className="font-body-md text-body-md text-[#4a4a4a]">
                {modo === "login" && "Ingresá tu email para comenzar a jugar."}
                {modo === "registro" && "Creá tu cuenta para empezar a jugar."}
                {modo === "olvide" && "Ingresá tu email y te mandamos un enlace para restablecerla."}
              </p>
            </div>
            ...
            <form className="space-y-3 sm:space-y-stack-md w-full" onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {modo === "login" && (
                      <button
                        ...
                        className="text-label-caps font-label-caps text-[#4a4a4a] hover:text-[#141414] transition-colors"
                      >
              ...
              >
                {loading ? (
                  ...
                  <>
                    <span>{modo === "login" ? "Continuar" : modo === "registro" ? "Crear cuenta" : "Enviar enlace"}</span>
